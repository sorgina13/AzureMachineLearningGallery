...
| type                | String                                                   | No       | Defines type of the Component. Defaults to `CommandComponent` if not specified. |
...
See [reference](../docs/component-spec-topics/code-snapshot.md) for more details of code snapshot.

### Tags
Some convention tags used by azure-ml-component package. Refer to [get-started-train](../samples/components/get-started-train/train.yaml) and [get-started-score](../samples/components/get-started-score/score.yaml) for more details.
...
**Data Types used by built-in components**
  ...
  > - Make sure that the input type of your component is aligned with the output type of the upstream component. The code logic behind these components should also be aligned.
